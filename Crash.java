	...
	public static void log(String message) {
		try {
			...
			final var st = new StringBuilder().append("\r\n//")
					...
					.append("\r\n//Your application window may have an option trhat can be checked to disable crash and run with Severe Errors.")
		...
		final var st2 = new StringBuilder().append("\r\n//")
				.append("Continuing without crash. Use results with cauion.").toString();
