...
public class ValidInstallation implements Constants {
	...
	**************************************************************************** */
	...
	public static boolean checkValidFiles() {
		...
		final var dir2 = APPLICATION_DIRECTORY + "\\Average-HandRangePlayability.ser";
		final var dir3 = APPLICATION_DIRECTORY + "\\Fish-HandRangePlayability.ser";
		final var dir4 = APPLICATION_DIRECTORY + "\\Hero-HandRangePlayability.ser";
		final var dir5 = APPLICATION_DIRECTORY + "\\Lag-HandRangePlayability.ser";
		final var dir6 = APPLICATION_DIRECTORY + "\\Tag-HandRangePlayability.ser";
		final var dir7 = APPLICATION_DIRECTORY + "\\Shark-HandRangePlayability.ser";
		...
		if (!exists(dir0)) {
			Popup.popup(new StringBuilder().append(msg1).append(dir1).append(msg2).toString());
			return false;
		}
		if (!exists(dir1)) {
			Popup.popup(new StringBuilder().append(msg1).append(dir1).append(msg2).toString());
		...
		if (!exists(dir2)) {
			Popup.popup(new StringBuilder().append(msg1).append(dir2).append(msg3).toString());
			return false;
		}
		if (!exists(dir3)) {
			Popup.popup(new StringBuilder().append(msg1).append(dir3).append(msg3).toString());
			return false;
		}
		if (!exists(dir4)) {
			Popup.popup(new StringBuilder().append(msg1).append(dir4).append(msg3).toString());
			return false;
		}
		if (!exists(dir5)) {
			Popup.popup(new StringBuilder().append(msg1).append(dir4).append(msg3).toString());
